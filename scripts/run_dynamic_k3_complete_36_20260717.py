...
VALIDATOR = ROOT / "scripts/validate_dynamic_k3_run_group_20260717.py"
...
def main() -> None:
    ...
    for group_index, (model_key, role) in enumerate(GROUPS, start=1):
        ...
        validation_path = ROOT / f"audits/derived/dynamic_k3_group_validation_{model_key}_{role}_20260717.json"
